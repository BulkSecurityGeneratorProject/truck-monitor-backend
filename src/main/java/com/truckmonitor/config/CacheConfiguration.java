package com.truckmonitor.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.truckmonitor.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.truckmonitor.repository.UserRepository.USERS_BY_EMAIL_CACHE);
